      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          ...
          >
            <button
              type="submit"
              className="w-full sm:w-auto flex items-center justify-center gap-1.5 border border-red-900 text-red-400 hover:bg-red-950 hover:text-red-300 px-4 py-2 rounded-xl text-sm transition-colors"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-3">
          {car.maintenances.map((m) => (
            <Link
              ...
              className="group flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-slate-800 border border-slate-700 hover:border-slate-600 rounded-2xl px-4 sm:px-5 py-4 transition-all hover:shadow-lg"
            >
              ...
              <div className="flex items-center justify-between sm:justify-start gap-3 sm:ml-4 w-full sm:w-auto">
